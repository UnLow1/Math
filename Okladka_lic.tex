...
%% SEKCJA 3 WKW na to, żeby graf był synchronizowalny z dowodem
\newpage
...
%% SEKCJA 4 Problem długości słowa synchronizującego
\section{Problem d{\l}ugo\'{s}ci s{\l}owa synchronizuj\k{a}cego.}

%% SEKCJA 5 Hipoteza Cernego
\section{Hipoteza \v Cernego.}


%% SEKCJA 6 Algorytm znajdowania słowa sychronizującego
\newpage
